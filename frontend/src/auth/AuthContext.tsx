  ...
  useEffect(() => {
    ...
    client
      .init({
        ...
        token: localStorage.getItem("kc_token") || undefined, // retrieve stored token
        refreshToken: localStorage.getItem("kc_refreshToken") || undefined, // retrieve stored refresh token
      })
      .then((authenticated) => {
